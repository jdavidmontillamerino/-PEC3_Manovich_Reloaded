...
```mermaid
flowchart LR
A[Cámaras] --> B[Tracking]
B --> C[Reconstrucción + reglas]
C --> D[Decisión in/out]
D --> E[Voz/animación]
...
[![Vídeo: Hawk-Eye en tenis (Short)](https://img.youtube.com/vi/Xnk2gWWY0dY/maxresdefault.jpg)](https://youtube.com/shorts/Xnk2gWWY0dY)
...
[![Vídeo: Tesla FSD (YouTube)](https://img.youtube.com/vi/GU16hXSSGKs/hqdefault.jpg)](https://youtu.be/GU16hXSSGKs)
...
```mermaid
flowchart LR
    A[Carretera física] --> B[Cámaras y sensores]
    B --> C[Percepción y modelos de IA]
    C --> D[Decisión de maniobra]
    D --> E[Acción del vehículo y pantalla]
```
## · Por qué es un caso de hibridación
